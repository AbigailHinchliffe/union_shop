...
class _HeroCarouselState extends State<HeroCarousel> {
  ...
  final _slides = const [
    HeroSlide(title: 'Browse Our Products', description: 'Discover our wide range of university merchandise', buttonText: 'BROWSE PRODUCTS', imageUrl: 'assets/images/customhoodie.jpg', route: '/product'),
